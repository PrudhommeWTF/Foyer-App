...
### La réutilisation d'un mot de passe
...
protections posées ne voit passer une connexion réussie du premier coup : ni la
temporisation, ni l'égalisation du temps de réponse, ni fail2ban. Le journal
dira « Connexion réussie » depuis une adresse inconnue, et c'est tout.

**Pourquoi il reste.** C'est le seul scénario que le second facteur couvrirait,
et il n'est pas implémenté.

**Ce qui le lèverait.** Un TOTP sur les comptes adultes. Deux à trois journées
de travail, sans dépendance nouvelle ni service tiers (voir la section 8 du
rapport d'audit). **C'est le premier chantier à envisager si vous voulez aller
plus loin.**

**En attendant.** Un mot de passe unique par personne, jamais réutilisé, et une
...
1. **Le second facteur (TOTP)** sur les comptes adultes. C'est le seul chantier
   qui traite un risque qu'aucune correction n'a couvert.
