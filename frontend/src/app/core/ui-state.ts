...
export interface UiState {
  ...
  evTitle: string; evTime: string; evEndTime: string; evPlace: string; evWho: string[]; evRecur: Recur; evEnd: string; evStart: string;
...
export function initialUi(): UiState {
  ...
  return {
    ...
    showEvent: false, evEditId: null, evTitle: '', evTime: '', evEndTime: '', evPlace: '', evWho: [], evRecur: 'none', evEnd: '', evStart: today, evPickStart: true, dpMonth: 0,
